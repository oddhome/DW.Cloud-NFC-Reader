/**
 * @file DWCLOUDWIFI.h
 * @brief implement ESP8266 basic wifi class for DW.CLOUD board
 * @author connect@deaware.com
 *
 * Ver 1.0 : Fork from ITEAD library change name ESP8266.cpp to DWCLOUDWIFI.cpp
 *         : Fix bug String processing in rcvPkg
 *         : Add more API for using with DW.CLOUD
 *
 * Ver 1.1 : Add string api for print and read
 *           Add Low level interface for TCP print
 *
 * @par Copyright:
 * Copyright (c) 2015 Deaware Systems Co., Ltd. \n\n
 * based on code by Copyright (c) 2015 ITEAD Intelligent Systems Co., Ltd. \n\n
...
#ifndef __DWCLOUD_WIFIH__
#define __DWCLOUD_WIFIH__
...
class ESP8266 {
 public:
    ...
    bool connectTCP(String addr, uint32_t port);
    ...
    /********************
     * send ESP8266 data via print command
     *
     ********************/
 ...
 private:
    ...
    bool sATCIPSENDSingleStr(String data);
...
#endif /* #ifndef __DWCLOUD_WIFIH__ */
